...
class FillPermissionsForDetailTask extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetailTask constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.detail-task',
            'admin.detail-task.index',
            'admin.detail-task.create',
            'admin.detail-task.show',
            'admin.detail-task.edit',
            'admin.detail-task.delete',
            'admin.detail-task.bulk-delete',
        ]);
