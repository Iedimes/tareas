...
class FillPermissionsForRolAdminUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRolAdminUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rol-admin-user',
            'admin.rol-admin-user.index',
            'admin.rol-admin-user.create',
            'admin.rol-admin-user.show',
            'admin.rol-admin-user.edit',
            'admin.rol-admin-user.delete',
            'admin.rol-admin-user.bulk-delete',
        ]);
